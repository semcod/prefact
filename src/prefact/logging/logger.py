...
class PprefactLogger:
    ...
    def log_scan_complete(
        self, duration: float, issues_found: int, fixes_applied: int
    ) -> None:
        self.info(
            "scan_completed",
    ...
    def log_rule_execution(
        self, rule_id: str, file_path: Path, duration: float, issues: int
    ) -> None:
        self.debug(
            "rule_executed",
    ...
    def log_performance_metrics(self, metrics: Dict[str, Any]) -> None:
        self.info("performance_metrics", event_type="performance", **metrics)
